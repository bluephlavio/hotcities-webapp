...
const About = (props) => {
	return (
		<div className="about">
            ...
            <p>
                <b>Follow. </b>
                Hot Cities is on <a href="https://twitter.com/intent/user?screen_name=hotcitiesworld" target="_blanck">twitter (@hotcitiesworld)</a>, <a href="https://www.instagram.com/hotcitiesworld/" target="_blanck">instagram (@hotcitiesworld)</a> and <a href="https://www.facebook.com/hotcitiesworld" target="_blanck">facebook</a>.
            </p>
