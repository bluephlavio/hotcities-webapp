...
const About = () => (
  <div className={style.about}>
    <InfoBit section="What it is">
      Hot Cities monitors world cities temperatures in real time from global weather services to
      determine the hottest one, right now.
    </InfoBit>
    ...
    <InfoBit section="Support">
      Like the project on{' '}
      <a href="http://github.com/bluephlavio/hotcities" target="_blank" rel="noopener noreferrer">
        github
      </a>
      .
    </InfoBit>
