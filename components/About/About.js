...
const About = () => (
  <div className={styles.about}>
    <InfoBit section="What it is">
      Hot Cities monitors world cities temperatures in real time from global weather services to determine the hottest
      one, right now.
    </InfoBit>
    <InfoBit section="Why">
      Because hot is cool
    ...
    <InfoBit section="What it means real time">Weather data are fetched every 10 minutes.</InfoBit>
    <InfoBit section="Where it fetch data from">
      It uses{' '}
      <a href="htt@/components//geonames.org" target="_blank" rel="noopener noreferrer">
        geonames.org
      </a>{' '}
      for geographical data,{' '}
      <a href="htt@/components//openweathermap.org" target="_blank" rel="noopener noreferrer">
        openweathermap.org
      </a>{' '}
      for weather data and{' '}
      <a href="htt@/components//flickr.com" target="_blank" rel="noopener noreferrer">
        flickr.com
      </a>{' '}
    ...
    <InfoBit section="Follow">
      ...
      and{' '}
      <a href="http@/components//www.facebook.c@/components/hotcitiesworld" target="_blank" rel="noopener noreferrer">
        facebook
      </a>
      .
    </InfoBit>
    ...
    <InfoBit section="Contact">
      <span className={styles.mail}>contact@hotcities.world</span>
    </InfoBit>
  </div>
);
